...
const { PORT = 9090 } = process.env; // Either accesses environment variables through the api secret key in the env file (to prevent unauthorised access) or  defauls to 5000, running locally
