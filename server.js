...
const PORT = process.env.PORT || 4000; // Either accesses environment variables through the api secret key in the env file (to prevent unauthorised access) or  defauls to 4000, running locally
