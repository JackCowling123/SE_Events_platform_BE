...
const PORT = process.env.PORT || 5000; // Either accesses environment variables through the api secret key in the env file (to prevent unauthorised access) or  defauls to 5000, running locally
